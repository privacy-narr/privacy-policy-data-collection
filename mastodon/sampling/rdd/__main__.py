...
parser.add_argument('--exclusions', nargs='+', help='A list of files containing instance domains to exclude.')
...
print('{} domains ({}, {}, ..., {})'.format(len(domains), domains[0], domains[1], domains[-1]))
